      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/landing" className="flex items-center gap-2.5">
              <img src="/favicon.svg" alt="WND Dialer Logo" className="h-8 w-8 rounded-lg shadow-sm" />
              <span className="text-base font-black tracking-tight text-slate-900">
                WND <span className="text-indigo-600">Dialer</span>
              </span>
            </Link>
            <p className="mt-3 text-sm leading-relaxed text-slate-500">
              AI-powered outbound dialing for call centers, sales teams, and agencies.
            </p>
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h3 className="text-xs font-semibold uppercase tracking-wider text-slate-900">{category}</h3>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-slate-200 pt-6 sm:flex-row">
          <p className="text-sm text-slate-400">
            &copy; 2025 WND Dialer. All rights reserved.
          </p>
          <p className="text-sm text-slate-400">
