...
const typography = {
  ...
  fontSize: 13.125,
  h1: { fontSize: "2.375rem", fontWeight: 600, lineHeight: 1.1, color: "#1e293b" },
  h2: { fontSize: "2rem", fontWeight: 600, lineHeight: 1.1, color: "#1e293b" },
  h3: { fontSize: "1.625rem", fontWeight: 600, lineHeight: 1.1, color: "#1e293b" },
  h4: { fontSize: "1.375rem", fontWeight: 600, lineHeight: 1.1, color: "#1e293b" },
  h5: { fontSize: "1.125rem", fontWeight: 600, lineHeight: 1.1, color: "#1e293b" },
  h6: { fontSize: "0.9375rem", fontWeight: 600, lineHeight: 1.1, color: "#1e293b" },
